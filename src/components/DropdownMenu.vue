...
<template>
  <div class="relative" ref="root">
    <img
      src="../assets/icons/kkrn_icon_user_1.png"
    ...
    >
      ...
      >
        <ul>
          <li
            class="text-gray-700 dark:text-gray-300 hover:bg-blue-100 dark:hover:bg-gray-700 hover:text-blue-600 dark:hover:text-blue-400 p-2"
          >
